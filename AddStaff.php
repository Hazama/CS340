...
<html>
 ...
 <?php
    ...
    if (!($stmt = $mysqli->prepare("INSERT INTO hospital_staff (fname, lname, title, hire, salary, dept) VALUES (?, ?, ?, ?, ?, ?)"))){
        echo "Prepare failed: (". $stmt->errno.") ".$stmt->error;
      }
      if (!($stmt->bind_param('ssssss', $_POST['fname'], $_POST['lname'], $_POST['title'], $_POST['hdate'], $_POST['salary'], $_POST['department']))){
  ...
  ?>
  <div>
    <a href="http://web.engr.oregonstate.edu/~mcinnisb/admin/AdminStaff.php">Back</a>
  </div>
</div>
</body>
</html>
