...
<html>
  ...
  <body>
  <h1>Medical Staff - Search Labs</h1>
   <nav>
  <h3>Front Desk</h3>
  <ul>
 ...
 <?php
if(!($stmt = $mysqli->prepare("SELECT fname, lname, lab_test.name, lab_test.description,
...
?>
  ...
  <div id="SLab">
  <h2>Search labs</h2>
  <form action="http://web.engr.oregonstate.edu/~mcinnisb/medical_staff/FilterLab.php" method="post">
	<fieldset>
	<legend>Search parameters</legend>
	<label>Patient First Name:<input type="text" name="fname" size="20" maxlength="100"></label>
	<label>Patient Last Name:<input type="text" name="lname" size="20" maxlength="100"></label>
	<label>Lab Name:<input type="text" name="labname" size="20" maxlength="100"></label>
	</br>
	</br>
	<label>Result:<input type="text" name="res" size="20" maxlength="100"></label>
	<label>Date:<input type="date" name="odate" size="20" maxlength="100"></label>
	</fieldset>
