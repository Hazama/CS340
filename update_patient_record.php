...
<html>
  ...
  <div>
    <span>Select patient to update medical records.</span>
    <form method="post" action="http://web.engr.oregonstate.edu/~mcinnisb/medical_staff/update_record.php">
      <fieldset>
        <legend>Edit Patient Medical Records</legend>
