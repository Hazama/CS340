...
<html>
  ...
  <body>
  <h1>Admin - Edit Department Info</h1>
   <nav>
  <h3>Front Desk</h3>
  <ul>
...
?>
  ...
  <form action="http://web.engr.oregonstate.edu/~mcinnisb/admin/EditDept.php" method="post">
	<fieldset>
	<legend>Data</legend>
	<label>Department ID:<input type="number" required name="did" size="20" maxlength="100"></label>
