...
<html>
  ...
  <body>
  <h1>Admin - View and Filter Staff</h1>
   <nav>
  <h3>Front Desk</h3>
  <ul>
...
?>
  ...
  <div id="AFS">
  <h2>Filter Staff</h2>
   <form action="http://web.engr.oregonstate.edu/~mcinnisb/admin/AFilterStaff.php" method="post">
	<fieldset>
	...
	<label>Salary:<input type="text" name="salary" size="20" maxlength="100"></label>
	<label>Hire Date:<input type="text" name="hdate" size="20" maxlength="100"></label>
	</br>
	</br>
	<label>Department:<select name="did">
	<option value=""></option>
	<?php
