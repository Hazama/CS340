...
<html>
 ...
 <?php
    ...
    if (!($stmt = $mysqli->prepare("UPDATE hospital_staff SET fname=?, lname=?, title=?, salary=?, dept=? WHERE id=?"))){
        echo "Prepare failed: (". $stmt->errno.") ".$stmt->error;
      }
      if (!($stmt->bind_param('ssssss', $_POST['fname'], $_POST['lname'], $_POST['title'], $_POST['salary'], $_POST['department'], $_POST['sid']))){
